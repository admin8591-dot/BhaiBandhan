...
(function () {
  ...
  const css = `
    ...
    /* bar 1: LIGHT THEME - warm cream with soft shadow */
    .bbtb-bar{background:#F8F1E8;padding:3px 12px;font-family:'Segoe UI',Arial,sans-serif;
      overflow:hidden;box-shadow:0 2px 6px rgba(122,31,31,0.08)}
    ...
    .bbtb-text{position:absolute;color:#7A1F1F;font-size:9.5px;font-weight:700;
      ...
      text-shadow:0 1px 2px rgba(122,31,31,0.08);letter-spacing:0.3px}
    @keyframes bbtb-scroll{0%{transform:translateX(0)}100%{transform:translateX(-100%)}}

    /* bar 2: DARK THEME - deep maroon with gold accents */
    .bbph-bar{background:linear-gradient(135deg,#7A1F1F,#5a1414);display:flex;align-items:center;
      gap:10px;padding:4px 14px;font-family:'Playfair Display','Cinzel',Georgia,'Times New Roman',serif;
      border-bottom:2px solid #D4AF37;box-shadow:0 4px 16px rgba(122,31,31,0.3)}
    ...
    .bbph-avatar{width:38px;height:38px;border-radius:50%;border:2px solid #D4AF37;
      ...
      box-shadow:0 2px 12px rgba(212,175,55,0.3),0 2px 8px rgba(0,0,0,0.2)}
    ...
    .bbph-wa{flex-shrink:0;width:30px;height:30px;border-radius:50%;
      ...
      text-decoration:none;box-shadow:0 2px 8px rgba(37,211,102,.3);
      transition:transform 0.2s ease}
    .bbph-wa:hover{transform:scale(1.05)}
    .bbph-wa svg{width:16px;height:16px;fill:#fff}

    /* Side Drawer - Premium styling */
    .bbdw-backdrop{position:fixed;inset:0;background:rgba(122,31,31,.6);z-index:99999;
    ...
    .bbdw-panel{position:fixed;top:0;left:0;bottom:0;width:86%;max-width:340px;
      ...
      box-shadow:6px 0 24px rgba(122,31,31,.3);
    ...
    .bbdw-close{position:absolute;top:14px;right:14px;width:34px;height:34px;
      border-radius:50%;background:#7A1F1F;border:2px solid #D4AF37;
      color:#F8F1E8;font-size:20px;line-height:1;cursor:pointer;
      box-shadow:0 2px 8px rgba(122,31,31,.3)}
    ...
    .bbdw-name{font-family:'Playfair Display','Cinzel',Georgia,'Times New Roman',serif;
      ...
      letter-spacing:0.5px;text-shadow:0 1px 2px rgba(122,31,31,0.08)}
    ...
    .bbdw-msg{display:flex;align-items:center;gap:12px;text-decoration:none;
      ...
      box-shadow:0 2px 8px rgba(122,31,31,0.08);
      transition:transform 0.2s ease}
    .bbdw-msg:hover{transform:scale(1.02)}
