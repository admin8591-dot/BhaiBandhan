    ...
    wrap.innerHTML = `
      <div style="background:#fff;border-radius:18px;max-width:360px;width:100%;overflow:hidden;box-shadow:0 20px 50px rgba(0,0,0,.35);position:relative;">
        ...
        <div style="padding:18px 22px 22px;text-align:center;">
          <p style="margin:0 0 12px;font-size:12px;color:#777;">Scan the QR to pay</p>
          ...
          <p style="font-size:11px;color:#999;margin:0 0 14px;">UPI ID: ${UPI_ID}</p>

          <p style="font-size:11px;color:#999;margin:0 0 8px;">Accepted on</p>
          <div style="display:flex;align-items:center;justify-content:center;gap:14px;margin-bottom:18px;">
            <button id="bbfGpayBtn" aria-label="Google Pay" style="border:1px solid #eee;border-radius:10px;padding:6px;background:#fff;cursor:pointer;line-height:0;">
              <img src="https://img.icons8.com/color/96/google-pay.png" alt="Google Pay" style="width:32px;height:32px;border-radius:7px;">
            </button>
            <button id="bbfPhonepeBtn" aria-label="PhonePe" style="border:1px solid #eee;border-radius:10px;padding:6px;background:#fff;cursor:pointer;line-height:0;">
              <img src="https://cdn.simpleicons.org/phonepe/5F259F" alt="PhonePe" style="width:32px;height:32px;background:#fff;border-radius:6px;">
            </button>
            <button id="bbfPaytmBtn" aria-label="Paytm" style="border:1px solid #eee;border-radius:10px;padding:6px;background:#fff;cursor:pointer;line-height:0;">
              <img src="https://img.icons8.com/color/96/paytm.png" alt="Paytm" style="width:32px;height:32px;border-radius:7px;">
            </button>
          </div>
